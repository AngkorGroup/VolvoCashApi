...
namespace VolvoCash.Domain.MainContext.Aggregates.ContactAgg
{
    public interface IContactRepository : IRepository<Contact>
    {
        ...
        Task<Contact> CreateOrUpdateMainContact(Client client, string phone, int documentTypeId, string documentNumber, string firstName, string lastName, string email);
